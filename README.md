...
- [✈️ Airline Service (항공사 예약 시스템)](#---airline-service-------------)
  * [👩🏻‍🎨 [IaaS] 아키텍처](#---------iaas------)
    + [1. 클라우드 아키텍처 구성](#1-------------)
      - [MSA 아키텍처 구성도](#msa---------)
  * [👷🏻 [Biz] 모델링](#------biz-----)
    + [1. 이벤트 스토밍](#1--------)
      ...
      - [시나리오 검증](#-------)
  * [🧑🏻‍💻 [Dev] MSA 개발](#---------dev--msa---)
    + [1. 분산 트랜잭션 `Saga` & 보상처리 `Compensation`](#1----------saga----------compensation-)
      - [시나리오](#-----1)
      - [작업 내용](#-----)
      - [작업 결과](#-----)
    + [2. 단일 진입점 `Gateway`](#2---------gateway-)
      - [[2-1. local환경] 작업 내용](#-2-1-local---------)
      - [[2-1. local환경] 작업 결과](#-2-1-local---------)
      - [[2-2. cloud환경] 작업 내용](#-2-2-cloud---------)
      - [[2-2. cloud환경] 작업 결과](#-2-2-cloud---------)
    + [3. 분산 데이터 프로젝션 `CQRS`](#3--------------cqrs-)
      - [시나리오](#-----2)
      - [작업 내용](#------1)
      - [작업 결과](#------1)
  * [🤵🏻‍♂️ [Ops/PaaS] 운영](#---------ops-paas----)
    + [1. 클라우드 배포 `Container`](#1----------container-)
      - [작업내용](#----)
      - [작업결과](#----)
    + [2. 컨테이너 자동 확장 `HPA`](#2-------------hpa-)
      - [시나리오](#-----3)
      - [작업내용](#-----1)
      - [작업결과](#-----1)
    + [3. 컨테이너로부터 환경 분리 `ConfigMap`](#3----------------configmap-)
      - [시나리오](#-----4)
      - [작업내용](#-----2)
      - [작업결과](#-----2)
    + [4. 클라우드 스토리지 활용 `PVC`](#4---------------pvc-)
      - [시나리오](#-----5)
      - [작업내용](#-----3)
      - [작업결과](#-----3)
    + [5. 무정지배포 `Rediness Probe`](#5--------rediness-probe-)
      - [작업내용](#-----4)
      - [작업결과](#-----4)
    + [6. 서비스 메쉬 응용 `Mesh`](#6------------mesh-)
      - [작업내용](#-----5)
      - [작업결과](#-----5)
    + [7. 통합 모니터링 `Loggeration/Monitoring`](#7----------loggeration-monitoring-)
      - [작업내용](#-----6)
      - [작업결과](#-----6)
  * [Model](#model)
  * [Before Running Services](#before-running-services)
    + [Make sure there is a Kafka server running](#make-sure-there-is-a-kafka-server-running)
  * [Run the backend micro-services](#run-the-backend-micro-services)
  * [Run API Gateway (Spring Gateway)](#run-api-gateway--spring-gateway-)
  * [Test by API](#test-by-api)
  * [Run the frontend](#run-the-frontend)
  * [Test by UI](#test-by-ui)
